...
class Settings:
    ...
    YOLO_MODEL: str      = "yolov8n-pose.onnx"  # UPGRADED: Nano Pose model for injury detection
    ...
    FRAME_SKIP_RATE: int = 1  # Run heavy MiDaS/Env checks only once every 30 frames
